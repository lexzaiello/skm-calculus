...
t_k :: Expr
t_k = (Call (Call S (Call (Call S (Call K (Call (Call S (Call K (Call (Call S (Call K S)) K))) K))) (Call (Call S K) K))) (Call (Call S (Call (Call S (Call K S)) (Call (Call S (Call (Call S (Call K S)) (Call (Call S (Call K K)) (Call K (Call (Call S (Call K (Call (Call S (Call K S)) K))) K))))) (Call (Call S (Call (Call S (Call K S)) (Call K K))) (Call K K))))) (Call (Call S (Call K K)) (Call (Call S K) K))))
