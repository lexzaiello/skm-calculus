/-
# Translation Algorithm from the CoC to SK
...
This appears circular. However, inline, eta-expanded calls to \\(\rightarrow\\) have an obvious representation, as defined above.
-/
